...
data = pd.read_csv("D://2//dongmoe2//3//canchafenlei//3dong1moe.csv")  # 替换为您的CSV文件路径
...
# 保存验证集预测结果和概率/
val_results.to_excel("D://2//dongmoe2//3//canchafenlei//3probabilities.xls", index=False)
